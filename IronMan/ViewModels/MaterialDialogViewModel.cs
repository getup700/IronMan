...
namespace IronMan.ViewModels
{
    public class MaterialDialogViewModel : ViewModelBase
    {
        ...
        private NotificationMessageAction<MaterialPlus> _message;
        ...
        public MaterialDialogViewModel(IMaterialService service, NotificationMessageAction<MaterialPlus> message)
        {
            this._service = service;
            this._message = message;
            if(message.Sender is MaterialPlus)
            {
